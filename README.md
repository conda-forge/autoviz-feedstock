...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/autoviz-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13710&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/autoviz-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `autoviz` can be installed with:

```
conda install autoviz
```

It is possible to list all of the versions of `autoviz` available on your platform with:
